...
const Dashboard = () => {
    ...
    const fetchDashboardData = async () => {
      ...
      try {
        ...
        console.log('Dashboard data received:', {
          orders: response.data.summary?.find(s => s.title === 'Total Orders')?.value,
          revenue: response.data.summary?.find(s => s.title === 'Revenue')?.value
        });
  ...
  // Get order type data directly from API
  const orderTypeData = dashboardData?.orderTypeData ?? [];
  
  // Calculate shipment status data from shipping cards
